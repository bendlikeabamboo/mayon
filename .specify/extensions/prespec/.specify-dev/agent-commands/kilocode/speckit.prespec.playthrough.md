...
4. **No idea folders at all**: stop and instruct — run `/speckit.prespec.idea` first to deal a deck.
...
- `PRESPEC_IDEA_DIR/cards/` **MUST** exist with at least 2 card files. If missing or thin, stop and instruct: run `/speckit.prespec.idea` first.
