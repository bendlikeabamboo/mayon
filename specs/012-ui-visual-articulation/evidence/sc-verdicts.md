...
| SC-7 | PASS (revised) | Owner reviewed and ruled out warmth ("gray palette, accent intact"); dark neutrals reverted to achromatic at identical lightness — comfort/hierarchy invariants held; see superseded-variant record + ruling note atop `us7-warm-charcoal.md`. |
