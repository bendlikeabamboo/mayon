...
export const MCP_SERVER_TEMPLATES: McpServerTemplate[] = [
	{
		label: 'Brave Search',
		description:
			'Web search via the official Brave Search MCP server (stdio). Exposes brave_web_search, brave_local_search, brave_image_search, brave_video_search, brave_news_search, and more. Requires the Mayon server.',
		transport: 'stdio',
		command: 'npx',
