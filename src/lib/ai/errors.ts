...
export const SERVER_REQUIRED_HINT =
	'Browser calls to this provider may be blocked by CORS. Start the Mayon server (docker compose up) for CORS-free access, or use a different provider.';
