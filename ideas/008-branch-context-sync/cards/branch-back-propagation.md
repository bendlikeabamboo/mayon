...
- **Your take**: Expects the op to steer the parent's future answers (yes, explicitly). Wants the propagated context anchored exactly where it was generated in the parent — a real artifact at its point in time that scrolls up as new turns arrive — not appended at the end. This takes aim at the placement/recency snag; residual wrinkle noted in play: parent turns generated _between_ the anchor and propagation time stay where they are and still ignore the correction.
