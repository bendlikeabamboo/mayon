...
Full evidence and re-test protocol: the
[019 — Security posture detection](../docs/history/019-security-posture-detection.qmd)
decision-history entry (Scenario 4; the original validation log is recoverable from
git history).
