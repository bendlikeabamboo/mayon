...
- **Trade-offs**: No first-class local onboarding, ever, for any runtime; findability for *today's* ~18 entries unimproved (the answer is subtraction, not navigation); education burden shifts permanently to users and docs.
